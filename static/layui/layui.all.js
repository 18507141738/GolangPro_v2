...
! function(e, t) {
	...
	l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05",
		...
		var n = this,
			...
			u = r.title ? '<iframe frameborder="0" marginwidth="0" marginheight="0" style="width: 100%; height:100%; position:absolute; z-index:-1; left:0px; top:0px;"></iframe> <div class="layui-layer-title" style="' +
			(f ? r.title[1] : "") + '">' + (f ? r.title[0] : r.title) + "</div>" : "";
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	}, d.Class = I, d.thisTable = c, d.init(), e(y, d)
});
layui.define("jquery", function(e) {
	"use strict";
	var i = layui.$,
