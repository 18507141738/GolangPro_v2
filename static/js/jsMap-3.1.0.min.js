...
! function(b, k) {
		...
		l = {
			...
			config: function(c, g, f) {
				var h = {
					...
					a = b.extend(!0, e, f);
				if(g && b.isPlainObject(g))
					if("taiwan" === a.name) console.warn("jsMap%20%E6%8F%90%E7%A4%BA%EF%BC%9A%E5%BE%88%E6%8A%B1%E6%AD%89%EF%BC%8C%E6%9A%82%E6%97%A0%E5%8F%B0%E6%B9%BE%E7%9C%81%E7%9A%84%E5%9C%B0%E5%9B%BE%E6%95%B0%E6%8D%AE%EF%BC%8C%E5%A6%82%E6%9C%89%E9%9C%80%E6%B1%82%EF%BC%8C%E8%AF%B7%E5%BC%80%E5%8F%91%E8%80%85%E8%87%AA%E8%A1%8C%E6%B7%BB%E5%8A%A0%E3%80%82");
					else {
						var k = "",
							l = "",
							q = [];
						b.each(g[a.name], function(b, a) {
							q.push(b);
								...
								c.find(".jsmap-" + e).on({
									mouseenter: function() {
										...
										if(!d.hasClass("jsmap-disabled")) {
											...
											a.tip && (!0 === a.tip && p.html('\x3cdiv \r\n\t\t\t\t\t\t\t\t\t\tstyle\x3d"\r\n\t\t\t\t\t\t\t\t\t\t\tpadding:10px 12px;\r\n\t\t\t\t\t\t\t\t\t\t\tcolor:#fff;\r\n\t\t\t\t\t\t\t\t\t\t\tfont-size:14px;\r\n\t\t\t\t\t\t\t\t\t\t\ttext-align:center;\r\n\t\t\t\t\t\t\t\t\t\t\tborder-radius:4px;\r\n\t\t\t\t\t\t\t\t\t\t\tborder:#777 solid 1px;\r\n\t\t\t\t\t\t\t\t\t\t\tbackground:rgba(0,0,0,.75);"\r\n\t\t\t\t\t\t\t\t\t\x3e' + d.attr("data-name") + "\x3c/div\x3e"), b.isFunction(a.tip) && p.html(a.tip(d.attr("data-id"), d.attr("data-name"))), t.on("mousemove", function(a) {
	...
	! function g(f) {
		Object.freeze(f);
		b.each(Object.keys(f), function(b, e) {
